        ...
        >
            ...
            {dataArray.map((item, index) => (
                <DataTable.Row key={"dtr-" + index} style={{ gap: dataFieldGap }}>
                    ...
                    <DataTable.Cell key={"dtc-FinalScheduleDate"} style={[defaultHeaders.FinalScheduleDate]}>
                        {item.FinalScheduleDate}
                    </DataTable.Cell>
                    <DataTable.Cell key={"dtc-FinalScheduleTime"} style={[defaultHeaders.FinalScheduleTime]}>
                        {item.FinalScheduleTime}
                    </DataTable.Cell>
